...
#define NODE_MAIN_LOGGER_NAME "apriltag_ros_single_image_client_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libapriltag_ros_single_image_client.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<apriltag_ros::SingleImageClient>";
