...
#include "apriltag_ros/srv/detail/analyze_single_image__rosidl_typesupport_fastrtps_c.h"
...
#include "apriltag_ros/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_apriltag_ros
...
using _AnalyzeSingleImage_Request__ros_msg_type = apriltag_ros__srv__AnalyzeSingleImage_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_apriltag_ros
size_t get_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AnalyzeSingleImage_Request__ros_msg_type * ros_message = static_cast<const _AnalyzeSingleImage_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AnalyzeSingleImage_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_apriltag_ros
size_t max_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = apriltag_ros__srv__AnalyzeSingleImage_Request;
    is_plain =
      (
...
static size_t _AnalyzeSingleImage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, srv, AnalyzeSingleImage_Request)() {
...
#include "apriltag_ros/msg/detail/april_tag_detection_array__functions.h"  // tag_detections

// forward declare type support functions
size_t get_serialized_size_apriltag_ros__msg__AprilTagDetectionArray(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_apriltag_ros__msg__AprilTagDetectionArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, msg, AprilTagDetectionArray)();


using _AnalyzeSingleImage_Response__ros_msg_type = apriltag_ros__srv__AnalyzeSingleImage_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tag_detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, apriltag_ros, msg, AprilTagDetectionArray
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_apriltag_ros
size_t get_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AnalyzeSingleImage_Response__ros_msg_type * ros_message = static_cast<const _AnalyzeSingleImage_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_apriltag_ros__msg__AprilTagDetectionArray(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_apriltag_ros
size_t max_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: tag_detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_apriltag_ros__msg__AprilTagDetectionArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = apriltag_ros__srv__AnalyzeSingleImage_Response;
    is_plain =
      (
      offsetof(DataType, tag_detections) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _AnalyzeSingleImage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_apriltag_ros__srv__AnalyzeSingleImage_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, srv, AnalyzeSingleImage_Response)() {
...
// already included above
// #include "apriltag_ros/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "apriltag_ros/srv/analyze_single_image.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, srv, AnalyzeSingleImage)() {
