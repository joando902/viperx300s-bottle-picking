...
class Metaclass_AnalyzeSingleImage_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('apriltag_ros')
        except ImportError:
            import logging
            import traceback
...
class AnalyzeSingleImage_Response(metaclass=Metaclass_AnalyzeSingleImage_Response):
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['apriltag_ros', 'msg'], 'AprilTagDetectionArray'),  # noqa: E501
    )
...
class Metaclass_AnalyzeSingleImage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'apriltag_ros.srv.AnalyzeSingleImage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from apriltag_ros.srv import _analyze_single_image
...
class AnalyzeSingleImage(metaclass=Metaclass_AnalyzeSingleImage):
    from apriltag_ros.srv._analyze_single_image import AnalyzeSingleImage_Request as Request
    from apriltag_ros.srv._analyze_single_image import AnalyzeSingleImage_Response as Response
