...
bool apriltag_ros__msg__april_tag_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("apriltag_ros.msg._april_tag_detection.AprilTagDetection", full_classname_dest, 55) == 0);
  }
  apriltag_ros__msg__AprilTagDetection * ros_message = _ros_message;
  {  // id
...
PyObject * apriltag_ros__msg__april_tag_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("apriltag_ros.msg._april_tag_detection");
