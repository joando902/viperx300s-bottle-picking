...
{
  new (message_memory) apriltag_ros::msg::AprilTagDetection(_init);
}

void AprilTagDetection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<apriltag_ros::msg::AprilTagDetection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AprilTagDetection_message_member_array[3] = {
  {
    ...
    offsetof(apriltag_ros::msg::AprilTagDetection, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(apriltag_ros::msg::AprilTagDetection, size),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(apriltag_ros::msg::AprilTagDetection, pose),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AprilTagDetection_message_members = {
  ...
  3,  // number of fields
  sizeof(apriltag_ros::msg::AprilTagDetection),
...
get_message_type_support_handle<apriltag_ros::msg::AprilTagDetection>()
{
  return &::apriltag_ros::msg::rosidl_typesupport_introspection_cpp::AprilTagDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, apriltag_ros, msg, AprilTagDetection)() {
  return &::apriltag_ros::msg::rosidl_typesupport_introspection_cpp::AprilTagDetection_message_type_support_handle;
}
