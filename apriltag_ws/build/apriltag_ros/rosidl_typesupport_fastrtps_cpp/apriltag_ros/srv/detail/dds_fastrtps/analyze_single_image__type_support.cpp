...
#include "apriltag_ros/srv/detail/analyze_single_image__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_ros
cdr_serialize(
  const apriltag_ros::srv::AnalyzeSingleImage_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  apriltag_ros::srv::AnalyzeSingleImage_Request & ros_message)
{
  // Member: full_path_where_to_get_image
  cdr >> ros_message.full_path_where_to_get_image;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = apriltag_ros::srv::AnalyzeSingleImage_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apriltag_ros::srv::AnalyzeSingleImage_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<apriltag_ros::srv::AnalyzeSingleImage_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_apriltag_ros
const rosidl_message_type_support_t *
get_message_type_support_handle<apriltag_ros::srv::AnalyzeSingleImage_Request>()
{
  return &apriltag_ros::srv::typesupport_fastrtps_cpp::_AnalyzeSingleImage_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros, srv, AnalyzeSingleImage_Request)() {
  return &apriltag_ros::srv::typesupport_fastrtps_cpp::_AnalyzeSingleImage_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_ros
cdr_serialize(
  const apriltag_ros::srv::AnalyzeSingleImage_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: tag_detections
  apriltag_ros::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  apriltag_ros::srv::AnalyzeSingleImage_Response & ros_message)
{
  // Member: tag_detections
  apriltag_ros::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    apriltag_ros::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: tag_detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        apriltag_ros::msg::typesupport_fastrtps_cpp::max_serialized_size_AprilTagDetectionArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = apriltag_ros::srv::AnalyzeSingleImage_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apriltag_ros::srv::AnalyzeSingleImage_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<apriltag_ros::srv::AnalyzeSingleImage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &apriltag_ros::srv::typesupport_fastrtps_cpp::_AnalyzeSingleImage_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros, srv, AnalyzeSingleImage_Response)() {
  return &apriltag_ros::srv::typesupport_fastrtps_cpp::_AnalyzeSingleImage_Response__handle;
}
...
{
  return &apriltag_ros::srv::typesupport_fastrtps_cpp::_AnalyzeSingleImage__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros, srv, AnalyzeSingleImage)() {
  return &apriltag_ros::srv::typesupport_fastrtps_cpp::_AnalyzeSingleImage__handle;
}
