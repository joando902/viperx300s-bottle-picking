...
#include "apriltag_ros/msg/detail/april_tag_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const apriltag_ros::msg::AprilTagDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  apriltag_ros::msg::AprilTagDetection & ros_message)
{
  // Member: id
  {
    cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = apriltag_ros::msg::AprilTagDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apriltag_ros::msg::AprilTagDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<apriltag_ros::msg::AprilTagDetection *>(
    untyped_ros_message);
...
{
  return &apriltag_ros::msg::typesupport_fastrtps_cpp::_AprilTagDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros, msg, AprilTagDetection)() {
  return &apriltag_ros::msg::typesupport_fastrtps_cpp::_AprilTagDetection__handle;
}
