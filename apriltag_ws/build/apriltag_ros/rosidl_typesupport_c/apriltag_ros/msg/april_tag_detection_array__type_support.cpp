...
static const _AprilTagDetectionArray_type_support_symbol_names_t _AprilTagDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, msg, AprilTagDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_ros, msg, AprilTagDetectionArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apriltag_ros, msg, AprilTagDetectionArray)() {
  return &::apriltag_ros::msg::rosidl_typesupport_c::AprilTagDetectionArray_message_type_support_handle;
}
