...
static const _AprilTagDetection_type_support_symbol_names_t _AprilTagDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, msg, AprilTagDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_ros, msg, AprilTagDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apriltag_ros, msg, AprilTagDetection)() {
  return &::apriltag_ros::msg::rosidl_typesupport_c::AprilTagDetection_message_type_support_handle;
}
