...
static const _AnalyzeSingleImage_Request_type_support_symbol_names_t _AnalyzeSingleImage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, srv, AnalyzeSingleImage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_ros, srv, AnalyzeSingleImage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apriltag_ros, srv, AnalyzeSingleImage_Request)() {
  return &::apriltag_ros::srv::rosidl_typesupport_c::AnalyzeSingleImage_Request_message_type_support_handle;
}
...
static const _AnalyzeSingleImage_Response_type_support_symbol_names_t _AnalyzeSingleImage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, srv, AnalyzeSingleImage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_ros, srv, AnalyzeSingleImage_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, apriltag_ros, srv, AnalyzeSingleImage_Response)() {
  return &::apriltag_ros::srv::rosidl_typesupport_c::AnalyzeSingleImage_Response_message_type_support_handle;
}
...
static const _AnalyzeSingleImage_type_support_symbol_names_t _AnalyzeSingleImage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, apriltag_ros, srv, AnalyzeSingleImage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_ros, srv, AnalyzeSingleImage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, apriltag_ros, srv, AnalyzeSingleImage)() {
  return &::apriltag_ros::srv::rosidl_typesupport_c::AnalyzeSingleImage_service_type_support_handle;
}
