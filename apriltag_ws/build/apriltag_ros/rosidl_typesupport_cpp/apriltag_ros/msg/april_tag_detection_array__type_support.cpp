...
static const _AprilTagDetectionArray_type_support_symbol_names_t _AprilTagDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros, msg, AprilTagDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, apriltag_ros, msg, AprilTagDetectionArray)),
  }
};
...
{
  return &::apriltag_ros::msg::rosidl_typesupport_cpp::AprilTagDetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, apriltag_ros, msg, AprilTagDetectionArray)() {
  return get_message_type_support_handle<apriltag_ros::msg::AprilTagDetectionArray>();
}
